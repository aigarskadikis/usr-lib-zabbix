...
// regEx pattern ti pick up site name
//var regexp = /^([0-9]+) (.*)$/gm;
//var match = regexp.exec(lines[l]);

// pick up name of profile
//var name=match[2];
var name=lines[l].replace(/^[0-9]+ /,'').match(/.*/)[0];
// ip range
var iprange='192.'+lines[l].replace(/ .*$/,'')+'.1.1-255';
